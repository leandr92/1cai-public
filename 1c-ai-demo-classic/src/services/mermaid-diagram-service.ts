export type DiagramType = 'flowchart' | 'sequence' | 'class' | 'state' | 'er' | 'gantt' | 'pie' | 'user-journey' | 'journey' | 'mindmap' | 'timeline' | 'requirement' | 'gitgraph';
...
export class MermaidDiagramService {
  ...
  getDiagramsByType(type: DiagramType): MermaidDiagram[] {
