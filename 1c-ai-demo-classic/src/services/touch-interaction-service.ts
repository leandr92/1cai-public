...
export class TouchInteractionService {
  ...
  private handleSwipeGesture(touch: globalThis.Touch | AppTouchEvent.TouchPoint): void {
  ...
  private emitTouchEvent(type: AppTouchEvent.TouchEvent['type'], touches: TouchList | AppTouchEvent.TouchPoint[]): void {
  ...
  public getGestureStats(): Observable<{
    totalTouches: number;
    gestureCount: number;
    tapCount: number;
    swipeCount: number;
    ...
    return new Observable(subscriber => {
      const stats = this.getTouchStats();
