  ...
  private createUserPersona(personaName: string): UserPersona {
    const personas = {
      'new-user': {
        ...
        preferences: { theme: 'auto', language: 'ru', timezone: 'Europe/Moscow', notifications: true, accessibility: { fontSize: 'moderate', contrast: 'normal', motion: true, sound: true, keyboard: true, screenReader: false } },
      ...
      'power-user': {
        ...
        preferences: { theme: 'dark', language: 'ru', timezone: 'Europe/Moscow', notifications: true, accessibility: { fontSize: 'moderate', contrast: 'normal', motion: true, sound: true, keyboard: true, screenReader: false } },
        accessibility: { wcagLevel: 'AA', assistiveTechnologies: [], cognitive: [], motor: [], visual: [], auditory: [] }
      }
    };
