  ...
  const checkSystemHealth = async () => {
    ...
    try {
      ...
      components.push({
        ...
        status: (apiTotal === 0 ? 'healthy' : apiHealthy === apiTotal ? 'healthy' : apiHealthy > apiTotal / 2 ? 'degraded' : 'unhealthy') as 'healthy' | 'degraded' | 'unhealthy',
    ...
    try {
      ...
      components.push({
        name: 'API Gateway',
        status: gatewayHealth.status as 'healthy' | 'degraded' | 'unhealthy',
