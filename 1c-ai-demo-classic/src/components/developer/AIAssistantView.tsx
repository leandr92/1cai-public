...
const AIAssistantView: React.FC = () => {
  ...
  const generateMockResponse = (userMessage: string): string => {
    ...
    return responses.length > 0 
      ...
      : `Я готов помочь с вопросом о "${cleanMessage}". Опишите подробнее, что именно вас интересует?`;
  };
