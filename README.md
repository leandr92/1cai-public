# 🤖 1C AI Stack — Де-факто Стандарт для AI-ассистированной разработки 1C
...
> **🎯 Де-факто стандарт** для AI-ассистированной разработки на 1C:Предприятие с **160 формализованными спецификациями**, покрывающими все аспекты платформы.
>
...
> - [`docs/DE_FACTO_STANDARD.md`](docs/DE_FACTO_STANDARD.md) — раздел про де-факто стандарт
...
**1C AI Stack** является **де-факто стандартом** для AI-ассистированной разработки на 1C:Предприятие:
