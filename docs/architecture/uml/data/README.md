...
|------|-----|----------------|
| `lifecycle.puml` | `png/lifecycle.png` | Жизненный цикл данных: сбор, обогащение, хранение, использование и архивирование. |
| `lineage.puml` | `png/lineage.png` | Data lineage: от источников 1С и внешних сервисов до витрин и ML пайплайнов. |
